...
// the vault, echoing the top banner — navy field, full-width lockup. Renders nothing when the
...
export default function SponsorBand() {
  ...
  return (
    <div style={{ background: theme.navy, borderRadius: 10, padding: '16px 18px', margin: '0 0 38px' }}>
