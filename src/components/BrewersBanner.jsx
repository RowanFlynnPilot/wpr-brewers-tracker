...
export default function BrewersBanner() {
  return (
    <div style={{ background: theme.navy, color: '#fff', padding: '26px 20px' }}>
      <div style={{ maxWidth: 880, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 18, flexWrap: 'wrap', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            ...
            <h1 style={{ fontFamily: theme.serif, fontSize: 36, lineHeight: 1.02, margin: '4px 0 0', fontWeight: 600 }}>The Brewers, by the numbers</h1>
